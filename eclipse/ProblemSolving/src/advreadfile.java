...
import java.util.*;
public class advreadfile {
	public static void main(String[] args)throws FileNotFoundException {
		ArrayList<Double> list = new ArrayList<Double>(); //Will be sending to a list rather than array
		...
		} catch (FileNotFoundException e) { //This catches when a file cannot be found in the directed path.
		    e.printStackTrace();
